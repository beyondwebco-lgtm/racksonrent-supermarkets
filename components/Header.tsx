      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 lg:hidden flex-shrink-0">
          <button
            type="button"
            onClick={handleListYourRack}
            className="inline-flex items-center gap-1 px-2.5 sm:px-3.5 py-2 rounded-full bg-[#F4E409] text-[#3D0710] text-[11px] sm:text-xs font-extrabold shadow-xs hover:bg-[#3D0710] hover:text-[#F4E409] transition-colors cursor-pointer whitespace-nowrap min-h-[40px]"
          >
          ...
          <button
            ...
            className="p-2 sm:p-2.5 rounded-xl text-[#6B0F1A] hover:text-[#3D0710] hover:bg-[#FFF6A3]/40 border border-[#F0E2E4] transition-colors cursor-pointer touch-target flex items-center justify-center"
          >
          ...
          <nav className="p-4 sm:p-6 space-y-1.5 flex-1">
            {NAV_LINKS.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => handleNavClick(e, link.href)}
                className="flex items-center min-h-[44px] px-4 py-3 rounded-xl font-extrabold text-base sm:text-lg text-[#6B0F1A] hover:bg-[#FFF6A3]/40 transition-colors"
              >
                {link.label}
              </a>
            ))}
