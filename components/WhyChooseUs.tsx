        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {WHY_CHOOSE_US.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="group rounded-3xl border-2 border-[#E5E7EB] bg-[#F9FAFB] p-5 sm:p-6 shadow-[0_12px_35px_rgba(107,15,26,0.06)] hover:shadow-[0_20px_50px_rgba(107,15,26,0.14)] hover:border-[#1F1F1F]/50 transition-all duration-300 hover:-translate-y-1.5 hover:scale-[1.01] flex flex-col justify-between"
              >
                <div>
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#FEF9C3] mb-5 shadow-xs group-hover:bg-[#1F1F1F] transition-colors duration-300">
                    <IconComp className="w-8 h-8 text-[#1F1F1F] group-hover:text-[#FEF9C3] group-hover:scale-110 transition-all duration-300" />
                  </div>
                  <h3 className="text-xl font-black text-[#1F1F1F] mb-2.5 group-hover:text-[#4B5563] transition-colors duration-300">
                    {item.title}
                  </h3>
