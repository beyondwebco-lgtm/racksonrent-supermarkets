    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-extrabold border transition-all cursor-pointer ${
                    isActive
                      ? "bg-[#1F1F1F] text-[#FEF9C3] border-[#FACC15] shadow-md scale-105"
                      : "bg-[#F9FAFB] text-[#1F1F1F] border-[#E5E7EB] hover:bg-[#FEF9C3]/40"
                  }`}
                >
                  <IconComp className={`w-4 h-4 flex-shrink-0 ${isActive ? "text-[#FACC15]" : "text-[#1F1F1F]"}`} />
        ...
        <div
          ...
          className="relative bg-[#F9FAFB] rounded-3xl border-2 border-[#1F1F1F] p-4 sm:p-10 px-4 sm:px-14 lg:px-16 shadow-[0_24px_70px_rgba(107,15,26,0.12)] overflow-hidden"
        >
          ...
          <button
            ...
            className="absolute left-1.5 sm:left-4 top-1/2 -translate-y-1/2 z-30 w-8 h-8 sm:w-11 sm:h-11 rounded-full bg-[#1F1F1F] text-[#FEF9C3] border-2 border-[#FACC15] flex items-center justify-center shadow-lg hover:bg-[#3D0710] hover:text-[#FACC15] hover:scale-105 transition-all cursor-pointer active:scale-95 touch-target"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center px-6 sm:px-0">
            ...
            >
              <div>
                <span className="inline-flex rounded-full bg-[#FEF9C3] px-3.5 py-1 text-xs font-black text-[#1F1F1F] border border-[#1F1F1F]/20">
                  {activeCategory.eyebrow}
                </span>
                <h3 className="mt-2.5 text-xl sm:text-3xl lg:text-4xl font-extrabold text-[#1F1F1F] leading-snug">
              ...
              <div>
                <span className="block text-xs font-extrabold text-[#1F1F1F] uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {activeCategory.suitableFor.map((item, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-1 rounded-lg bg-[#FEF9C3]/60 text-[#3D0710] text-[11px] sm:text-xs font-bold border border-[#1F1F1F]/10"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {activeCategory.benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-xs sm:text-sm text-[#4B5563] font-extrabold">
                      <CheckCircle2 className="w-4 h-4 text-[#1F1F1F] flex-shrink-0" />
                      <span>{benefit}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#FACC15] text-[#3D0710] border border-[#1F1F1F]/30 px-5 sm:px-6 py-3 font-extrabold text-xs sm:text-sm shadow-xs hover:bg-[#3D0710] hover:text-[#FACC15] transition-all cursor-pointer min-h-[44px]"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#1F1F1F] text-[#FEF9C3] border border-[#1F1F1F] px-5 sm:px-6 py-3 font-extrabold text-xs sm:text-sm shadow-xs hover:bg-[#3D0710] hover:text-[#FACC15] transition-all cursor-pointer min-h-[44px]"
                >
            ...
            <div className="lg:col-span-5 relative mt-4 lg:mt-0">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#1F1F1F]/20 bg-[#3D0710] shadow-[0_16px_40px_rgba(107,15,26,0.15)] aspect-4/5 w-full max-w-lg mx-auto group">
                <Image
                ...
                <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 bg-[#3D0710] text-white px-3.5 sm:px-5 py-2.5 sm:py-3 rounded-2xl border-2 border-[#FACC15] shadow-xl flex items-center justify-between text-xs sm:text-sm lg:text-base font-bold tracking-wide z-10">
        ...
        <div className="mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 pt-6 border-t border-[#E5E7EB]">
          {SHOWCASE_TRUST_ITEMS.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="p-2 rounded-xl bg-[#FEF9C3] text-[#1F1F1F] flex-shrink-0">
                  <IconComp className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs font-extrabold text-[#1F1F1F] leading-tight">
                    {item.label}
                  </h4>
