...
export default function TopBar() {
  return (
    <div className="bg-[#6B0F1A] text-white text-[11px] sm:text-xs border-b border-[#3D0710] py-2 px-3 sm:px-6 lg:px-8 font-semibold relative z-50 overflow-hidden">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        
        {/* Left Side */}
        <div className="flex items-center gap-1.5 text-[#FFF6A3] truncate min-w-0">
