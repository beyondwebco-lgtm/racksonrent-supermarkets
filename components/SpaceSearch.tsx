          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 items-end">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#F0E2E4] bg-white px-3 py-2.5 text-[#B8913A] text-xs sm:text-sm outline-none transition focus:border-[#6B0F1A] focus:ring-2 focus:ring-[#FFF6A3] font-medium min-h-[44px]"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full max-w-full rounded-xl border border-[#F0E2E4] bg-white px-3 py-2.5 text-[#B8913A] text-xs sm:text-sm outline-none transition focus:border-[#6B0F1A] focus:ring-2 focus:ring-[#FFF6A3] font-medium min-h-[44px] truncate"
              >
